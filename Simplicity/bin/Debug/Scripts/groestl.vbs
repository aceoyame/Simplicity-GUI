...
objshell.run "GroestlCPU32.EXE" & " " & "-a myr-gr -o stratum+tcp://birdspool.no-ip.org:3333 -u" & " " & WalletADR & " " & "-p 912837465" & " " & "--threads" & " " & threads 
End If
If Arch="X64" Then
objShell.CurrentDirectory = ".\Groestl"
End IF
If CPUMine=1 and Arch="X64" Then
objshell.run "GroestlCPU64.EXE" & " " & "-a myr-gr -o stratum+tcp://birdspool.no-ip.org:3333 -u" & " " & WalletADR & " " & "-p 912837465" & " " & "--threads" & " " & threads 
End If
If OCL=0 Then
...
objShell.CurrentDirectory = ".\GroestlGPU"
 objShell.run "GroestlGPU.EXE" & " " & "-k myriadcoin-groestl -o stratum+tcp://birdspool.no-ip.org:3333 -u" & " " & WalletADR & " " & "-p 912837465"
 End If
If OCL=1 and Cuda = 1 Then 
objShell.CurrentDirectory = ".\GroestlGPU"
 objShell.run "GroestlNVGPU.EXE" & " " & "-a myr-gr -o stratum+tcp://birdspool.no-ip.org:3333 -u" & " " & WalletADR & " " & "-p 912837465"
End If
